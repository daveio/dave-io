...
export class AiAlt extends OpenAPIRoute {
    ...
    async handle(c) {
        ...
        return authorizeEndpoint("ai", "alt")(c, async () => {
            if (!image) {
                return this.processor.createErrorResponse(c, "No image provided. Please provide an image URL or upload an image directly.", "NO_IMAGE_PROVIDED");
            }
            const authContext = c;
...
//# sourceMappingURL=alt-get.js.map