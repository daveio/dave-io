import { z } from "zod";
import { ErrorResponseSchema, JWTDetailsSchema, UserSchema } from "./common";
...
export const AuthRouteSchema = {
    ...
    description: "Endpoint to test JWT authentication and retrieve token details. Accepts tokens via Authorization header or query parameter.",
    request: {
