import { z } from "zod";
import { ErrorResponseSchema, RateLimitSchema } from "./common";
...
export const AiAltGetRouteSchema = {
    ...
    description: "Generates descriptive alt text for an image using Cloudflare AI. Requires JWT authentication with 'ai' or 'ai:alt' permissions. Rate limited to 100 requests per hour.",
    security: [{ bearerAuth: [] }],
    request: {
...
export const AiAltPostRouteSchema = {
    ...
    description: "Generates descriptive alt text for a base64-encoded image using Cloudflare AI. Requires JWT authentication with 'ai' or 'ai:alt' permissions. Rate limited to 100 requests per hour. Maximum image size: 4MB.",
    security: [{ bearerAuth: [] }],
    request: {
        body: {
            content: {
