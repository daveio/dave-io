...
const openapi = fromHono(app, {
    ...
    schema: {
        info: {
            title: "dave.io",
            version: "1.0.0",
            description: "A multipurpose personal API powered by Cloudflare Workers. Provides endpoints for health checks, URL redirection, dashboard feeds, RouterOS script generation, metrics, JWT authentication, token management, and AI-powered services."
        },
        tags: [
