 ...
 * Store a redirect
 */
export async function setRedirect(env, redirect) {
    try {
 ...
 * Delete a redirect
 */
export async function deleteRedirect(env, slug) {
    try {
 ...
 */
export async function trackRedirectClick(env, slug) {
    try {
 ...
 */
export async function getRedirectStats(env, slug) {
    try {
 ...
 */
export async function getAllRedirectStats(env) {
    try {
