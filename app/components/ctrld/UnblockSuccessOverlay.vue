        ...
        <div class="max-w-4xl mx-auto p-8 text-center">
              ...
              <div class="card-body">
                <div class="flex items-start gap-6">
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-2xl text-subtext0">
                      If the website is still blocked after reopening your browser, press the refresh button (F5 or Cmd+R) and it should work.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="mt-8 p-6 bg-surface0 rounded-lg">
            <p class="text-2xl">
              ...
              <span class="text-green font-mono">{{ domain }}</span>
            </p>
