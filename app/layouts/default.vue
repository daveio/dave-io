    ...
    <div class="max-w-3xl mx-auto w-full relative z-10">
      <div>
        ...
        <div ref="interfaceContainer"
          ...
          <div ref="interfaceContent"
            :class="['terminal-content text-text p-4 text-sm flex-1 overflow-y-auto', useMonospace ? 'font-[\'Victor_Mono\']' : '']">
            <slot />
          </div>
        </div>
      </div>
          ...
          <div class="text-center p-4 font-['Victor_Mono'] text-text text-sm">
            ...
            <div class="text-subtext1">
              <button
                ...
                title="Click to copy to clipboard" @click="copyCurlCommand">
