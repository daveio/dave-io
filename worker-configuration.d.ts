/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 687afe24646a76f043138dc31bf2d5a3)
// Runtime types generated with workerd@1.20251210.0 2025-09-07 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		CACHE: KVNamespace;
		KV: KVNamespace;
		CLOUDFLARE_ACCOUNT_ID: "def50674a738cee409235f71819973cf";
		CLOUDFLARE_DATABASE_ID: "b7438090-d76e-4b31-9041-2df146c88cae";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "SENTRY_ENVIRONMENT">> {}
}
